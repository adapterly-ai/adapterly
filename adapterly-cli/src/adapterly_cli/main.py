...
Usage:
    ...
    adapterly tools
    adapterly tools --search infrakit
    adapterly call infrakit_projects_list
    adapterly call infrakit_measurements_list --param dateFrom=2026-01-01
    adapterly call infrakit_projects_get --param uuid=abc-123 --output json
"""
...
def call(tool_name, param, json_input, output):
    ...
    Examples:
        adapterly call infrakit_projects_list
        adapterly call infrakit_measurements_list -p dateFrom=2026-01-01
        adapterly call infrakit_projects_get -p uuid=abc-123
